...
os.system("adduser socinftp --home /usr/socin/econect/ftp --shell /bin/bash")
os.system("sed -i 's/PermitRootLogin no/PermitRootLogin yes/g' /etc/ssh/sshd_config")
os.system("sed -i 's/PermitRootLogin prohibit-password/PermitRootLogin yes/g' /etc/ssh/sshd_config")
os.system("sed -i 's/PermitRootLogin yes /PermitRootLogin yes/g' /etc/ssh/sshd_config")